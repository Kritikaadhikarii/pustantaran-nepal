...
const SupportUs = () => {
  const [viewMode, setViewMode] = useState("all"); // 'all', 'benefits', 'support', 'members'
  ...
  return (
    <section className="bg-gray-100 py-10 px-6">
      ...
      <div className="container mx-auto mb-8 text-center">
        <h1 className="text-teal-600 font-playfair text-6xl font-bold mb-4">
          Support Us
        </h1>
        <p className="mb-4 text-gray-700 max-w-3xl mx-auto">
          <span
            onClick={handleMembershipClick}
            className="font-bold text-teal-500 cursor-pointer hover:underline mb-12"
          >
            Membership Link
          </span>
        </p>
          ...
          <Card>
            <div className="max-w-4xl mx-auto py-6">
              <p className="text-gray-700 text-center text-lg mb-12 max-w-3xl mx-auto leading-relaxed">
                ...
                coordination and cooperation with all stakeholders. If you want
                to bring a positive change in the lives of senior citizens in
                Nepal,{" "}
              ...
              <div className="grid md:grid-cols-2 gap-12 items-start">
                <div className="space-y-6">
                  ...
                  <ul className="list-disc ml-6 text-gray-700 space-y-3">
                    ...
                    <li>Connecting us with potential funding sources.</li>
                    <li>
                      Providing valuable technical expertise in the field of
                      senior care.
                    </li>
                ...
                <div className="flex flex-col items-center justify-center bg-gray-50 p-8 rounded-lg">
                  ...
                  />
                  <p className="text-teal-600 font-semibold mt-4 text-lg">
                    Scan to Support Us
                  </p>
                  <button
      ...
      {(viewMode === "all" || viewMode === "support") && <SupportHelp />}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                Members and their families will receive prioritized care and
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                Members will enjoy significant discounts on services, making it
                easier and more affordable for them to access senior care and
                other services offered by the organization.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                Being a member provides the opportunity to connect with
                like-minded individuals, professionals, and organizations
                working toward the common goal of senior citizens welfare.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                Members will be recognized for their contributions, with
                opportunities to receive acknowledgments for their support and
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                Membership offers the satisfaction of being part of a
                meaningful, impactful cause that improves the lives of senior
                citizens and enhances the community&apos;s social fabric.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                Members will be regularly informed about the organization&apos;s
                initiatives, progress, and future opportunities to engage in
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-teal-600 mb-2 text-center">
                Discounted or Free Health Services
              </h3>
              <p className="text-gray-600 text-center">
                Depending on the membership level, members may receive
                discounted or free health check-ups, counseling, or mental
                health support services for senior citizens.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow">
              ...
              <p className="text-gray-600 text-center">
                By being a member, individuals contribute to creating lasting
                changes and better living conditions for senior citizens,
      ...
      {(viewMode === "all" || viewMode === "members") && <MemberList />}
