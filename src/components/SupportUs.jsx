  ...
  return (
    <section className="bg-gray-100 py-10 px-6">
      <div className="container mx-auto max-w-4xl mb-8">
        ...
        >
          {showSupportHelp ? "View Support Us" : "View How Your Support Helps"}
            ...
            <Card>
              ...
              <div className="grid md:grid-cols-2 gap-8 items-start">
                ...
                <div className="flex flex-col items-center justify-center">
                  ...
                  <p className="text-teal-600 font-semibold mt-2">Scan to Support Us</p>
                  <button
                    onClick={handleDownloadQR}
                    className="mt-2 bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-md text-sm flex items-center gap-2"
                  >
