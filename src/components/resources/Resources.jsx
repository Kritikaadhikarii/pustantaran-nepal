        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center">
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 w-full max-w-md">
            ...
            <p className="text-gray-700 leading-relaxed">
              Access our research papers, reports, and publications on senior
              citizen issues and care practices.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 w-full max-w-md">
            ...
            <p className="text-gray-700 leading-relaxed">
              Stay updated with our monthly newsletters covering latest
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 w-full max-w-md">
            <div className="flex items-center mb-6">
              <FaPlayCircle className="text-4xl text-teal-500 mr-4" />
              <h3 className="font-playfair text-2xl font-semibold text-teal-500">
                Audio-Visual Content
              </h3>
            </div>
            <p className="text-gray-700 leading-relaxed">
              Access our collection of audio and visual contents about elderly
              care, health tips, and inspiring senior stories.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 w-full max-w-md">
            ...
            <p className="text-gray-700 leading-relaxed">
              Find information about senior citizens&rsquo; rights, laws, and policies
              in Nepal.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 w-full max-w-md">
            ...
            <p className="text-gray-700 leading-relaxed">
              Access comprehensive guidelines for senior care centers and
              caregivers.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 w-full max-w-md">
            ...
            <p className="text-gray-700 leading-relaxed">
              Download necessary forms and documents for various services and
              procedures.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 w-full max-w-md">
            ...
            <p className="text-gray-700 leading-relaxed">
              Explore data and research findings related to senior citizens in
              Nepal.
            </p>
          </div>
        </div>
